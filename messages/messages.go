...
type MessageData struct {
	...
	AirlineSentimentConfidence float64 `json:"airlineSentimentConfidence,omitempty"`
	NegativeReason             string  `json:"negativereason,omitempty"`
	NegativeReasonConfidence   float64 `json:"negativereasonConfidence,omitempty"`
	...
	TweetCoord                 string  `json:"tweetCoord,omitempty"`
